      ...
      <MainProjectTheme className={themeContext.theme}>
        <SectionProject>
          ...
          <BoxGridTwo>
            ...
            <TextBodyOne>
              Esta aplicación de productividad cuenta con una funcionalidad de pomodoro para ayudar
              a aumentar la eficiencia y productividad. Además, permite la adición de tareas para
              llevar un registro organizado de las tareas pendientes. La aplicación también cuenta
              con opciones de configuración para personalizarla según las preferencias del usuario.
              Este proyecto fue un reto significativo en mi camino de aprendizaje de JavaScript
              Vanilla y estoy muy orgulloso del resultado logrado.
            </TextBodyOne>
